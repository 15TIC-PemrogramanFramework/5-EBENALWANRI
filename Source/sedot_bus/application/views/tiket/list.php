                                ...
                                <article class="tour-post animated fadeInDownShort">
                                    ...
                                    <div class="tour-contents clearfix">
                                        <figure class="tour-feature-img">
                                            <a href="<?php echo base_url('tiket/detil/'.$tiket['id_tiket']);?>"> <img src="<?php echo base_url();?>assets/front/images/tour-carousel-img-1.jpg" alt="Image"/></a>
                                        </figure>
                                        <h5 class="entry-title p-name"><a href="single-where-we-go.html"><?php echo $tiket['nama_tiket'];?></a></h5>
                                        ...
                                        <a class="more-details u-url" href="<?php echo base_url('index.php/tiket/detil/'.$tiket['id_tiket']);?>">Lihat Tiket <i class="fa fa-angle-double-right"></i></a>
                                    </div>
                                </article>
                            </div>
                        <?php } ?>
