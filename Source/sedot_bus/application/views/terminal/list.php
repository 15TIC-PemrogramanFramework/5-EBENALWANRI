                                ...
                                <article class="tour-post animated fadeInDownShort">
                                    ...
                                    <div class="tour-contents clearfix">
                                        <figure class="tour-feature-img">
                                            <a href="<?php echo base_url('terminal/detil/'.$terminal['id_terminal']);?>"> <img src="<?php echo base_url();?>assets/front/images/tour-carousel-img-1.jpg" alt="Image"/></a>
                                        </figure>
                                        <h5 class="entry-title p-name"><a href="single-where-we-go.html"><?php echo $terminal['nama_terminal'];?></a></h5>
                                        ...
                                        <a class="more-details u-url" href="single-where-we-go.html">See tour details <i class="fa fa-angle-double-right"></i></a>
                                    </div>
                                </article>
                            </div>
                        <?php } ?>
