...
<div class="modal-dialog">
  <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="<?php echo base_url('index.php/admin/users/admin') ?>" method="post">
...
<tbody>
    ...
    <tr class="odd gradeX">
        ...
        <a href="<?php echo base_url('index.php/admin/users/delete_admin/'.$admin['id_admin']) ?>" class="btn btn-danger" onClick="return confirm('Yakin ingin menghapus user ini?')"><i class="fa fa-trash"></i></a>
